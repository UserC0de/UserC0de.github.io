...
<head prefix="og: http://ogp.me/ns#">
    ...
    <title>Hack The Box - Access – sckull</title>
...
<script>
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var permalink = JSON.parse("\"https://sckull.github.io/posts/access/\"");
...
<meta name="description" content="Access con Sistema Operativo Windows y dificultad facil, presenta un servicio FTP el cual contiene una base de datos donde encontramos un correo electronico con credenciales que utilizamos en Telnet. Utilizando las credenciales guardadas ejecutamos un payload de metasploit para obtener acceso privilegiado." />


<meta name="keywords" content="ftp,readpst,telnet,runas">

<meta name="created" content="2019-03-02T00:00:00&#43;0000">
<meta name="modified" content="2019-03-02T00:00:00&#43;0000">
<meta property="article:published_time" content="2019-03-02T00:00:00&#43;0000">

<meta name="author" content="sckull">
<meta property="article:author" content="https://sckull.github.io/posts/access/@sckull">


<meta property="og:site_name" content="sckull">
<meta property="og:title" content="Hack The Box - Access">
<meta property="og:url" content="https://sckull.github.io/posts/access/">
<meta property="og:type" content="article">
<meta property="og:description" content="Access con Sistema Operativo Windows y dificultad facil, presenta un servicio FTP el cual contiene una base de datos donde encontramos un correo electronico con credenciales que utilizamos en Telnet. Utilizando las credenciales guardadas ejecutamos un payload de metasploit para obtener acceso privilegiado.">

  
    <meta property="og:image" content="https://sckull.github.io/images/posts/htb/access/cover.webp">
    <meta property="og:image:url" content="https://sckull.github.io/images/posts/htb/access/cover.webp">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:app:name:iphone" content="sckull">
    <meta property="twitter:title" content="Hack The Box - Access">
    <meta property="twitter:description" content="Access con Sistema Operativo Windows y dificultad facil, presenta un servicio FTP el cual contiene una base de datos donde encontramos un correo electronico con credenciales que utilizamos en Telnet. Utilizando las credenciales guardadas ejecutamos un payload de metasploit para obtener acceso privilegiado.">
...
<link rel="canonical" href="https://sckull.github.io/posts/access/">
    ...
    <script type="application/ld+json">
  {
    ...
    "@type": "WebPage",
    "headline": "Hack The Box - Access",
    "datePublished": "2019-03-02T00:00:00Z",
    "dateModified": "2019-03-02T00:00:00Z",
    "url" : "https://sckull.github.io/posts/access/",
    "description": "Access con Sistema Operativo Windows y dificultad facil, presenta un servicio FTP el cual contiene una base de datos donde encontramos un correo electronico con credenciales que utilizamos en Telnet. Utilizando las credenciales guardadas ejecutamos un payload de metasploit para obtener acceso privilegiado.",
    "keywords": ["ftp","readpst","telnet","runas"],
    "image" : "https://sckull.github.io/images/posts/htb/access/cover.webp",
    "author": {
      "@type": "Person",
      "name": "sckull"
    },
...
<main class="single__main main">
  ...
  <div class="single ">
    ...
    <h2 class="single__title" data-ani="true">Hack The Box - Access</h2>
    <div class="single__meta">
      
<div class="single__infos">
  <time class="single__info" title="Written At">📅&nbsp;Mar 2, 2019 </time>
...
<ul class="single__tags caption">
  ...
  <li><a href="https://sckull.github.io/tags/ftp/" class="single__tag" title="ftp">ftp</a></li>
  

  <li><a href="https://sckull.github.io/tags/readpst/" class="single__tag" title="readpst">readpst</a></li>
  

  <li><a href="https://sckull.github.io/tags/telnet/" class="single__tag" title="telnet">telnet</a></li>
  

  <li><a href="https://sckull.github.io/tags/runas/" class="single__tag" title="runas">runas</a></li>
  ...
  <div class="featured-image__wrapper">
    <img src="/images/posts/htb/access/cover.webp" alt="featured image" class="featured-image" style="width: ;height: ;">
  </div>
...
<p><img src="/images/posts/htb/access/Screenshot_20190302_204827.webp" alt="image" /></p>
...
<p><img src="/images/posts/htb/access/Screenshot_20190302_211423.webp" alt="image" /></p>
<hr />
<h3 id="auth_user">auth_user</h3>
<p><img src="/images/posts/htb/access/Screenshot_20190302_210754.webp" alt="image" /></p>
...
<img src="/images/posts/htb/access/Screenshot_20190302_213222.webp" alt="image" /><br />
<img src="/images/posts/htb/access/Screenshot_20190302_213546.webp" alt="image" /></p>
...
<img src="/images/posts/htb/access/Screenshot_20190302_213721.webp" alt="image" /></p>
<p>Se muestra la solicitud de descarga en el servidor python.<br />
<img src="/images/posts/htb/access/Screenshot_20190302_213738.webp" alt="image" /></p>
...
<img src="/images/posts/htb/access/Screenshot_20190302_213835.webp" alt="image" /></p>
<ul>
...
<div class="donation">
  ...
  <div class="donation__icons">
        ...
        <a href="https://www.facebook.com/sharer/sharer.php?u=https%3a%2f%2fsckull.github.io%2fposts%2faccess%2f" title="Facebook" aria-label="Facebook Share Button" class="donation__item" target="_blank" rel="noreferrer" data-type="share">
        ...
        <a href="https://www.linkedin.com/shareArticle?mini=true&url=https%3a%2f%2fsckull.github.io%2fposts%2faccess%2f&title=Hack%20The%20Box%20-%20Access &summary=Access%20con%20Sistema%20Operativo%20Windows%20y%20dificultad%20facil%2c%20presenta%20un%20servicio%20FTP%20el%20cual%20contiene%20una%20base%20de%20datos%20donde%20encontramos%20un%20correo%20electronico%20con%20credenciales%20que%20utilizamos%20en%20Telnet.%20Utilizando%20las%20credenciales%20guardadas%20ejecutamos%20un%20payload%20de%20metasploit%20para%20obtener%20acceso%20privilegiado.&source=Walkthrough%20-%20Writeups%20%3a%3a%20TryHackMe%2c%20HackTheBox%2c%20CTFs%2c%20espa%c3%b1ol" target="_blank" rel="noreferer" title="LinkedIn" aria-label="LinkedIn Share Button" class="donation__item" data-type="share">
        ...
        <a href="https://twitter.com/intent/tweet?text=Hack%20The%20Box%20-%20Access&url=https%3a%2f%2fsckull.github.io%2fposts%2faccess%2f&hashtags=ftp%2creadpst%2ctelnet%2crunas&via=sckull" title="Twitter" aria-label="Twitter Share Button" class="donation__item" target="_blank" rel="noreferrer" data-type="share">
...
<nav class="pagination-single">
      ...
      <a href="https://sckull.github.io/posts/conceal/" class="pagination-single__left">
        <div class="pagination-single__icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path fill="currentColor" d="M19 11H7.83l4.88-4.88c.39-.39.39-1.03 0-1.42-.39-.39-1.02-.39-1.41 0l-6.59 6.59c-.39.39-.39 1.02 0 1.41l6.59 6.59c.39.39 1.02.39 1.41 0 .39-.39.39-1.02 0-1.41L7.83 13H19c.55 0 1-.45 1-1s-.45-1-1-1z"/></svg>
        </div>
        <div class="pagination-single__left-title">Hack The Box - Conceal</div>      
      </a>
    
    <div class="grow"></div>
    
      <a href="https://sckull.github.io/posts/frolic/" class="pagination-single__right">      
        <div class="pagination-single__right-title">Hack The Box - Frolic</div>
        <div class="pagination-single__icon">
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
              ...
              <a href="https://sckull.github.io/posts/access/" data-lang="es" class="dropdown-item is-active">Español</a>
      ...
      <ul>
        <li>
          <ul>
            ...
            <li><a href="#auth_user">auth_user</a></li>
          </ul>
        </li>
      </ul>
    </li>
    <li><a href="#telnet---obteniendo-acceso">Telnet - Obteniendo Acceso</a></li>
