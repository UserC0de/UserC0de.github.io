...
<p>Esto pues basicamente permiten establecer conecciones entre el microcontrolador y los diferentes sensores y actuadores de una manera bastante sencilla, generalmente suele ser con cables [Dupons](https://www.amazon.com/dupont-cable/s?k=dupont+cable).
